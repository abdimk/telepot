...
def on_chat_message(msg):
    ...
    if command == '/start':
        markup = InlineKeyboardMarkup(inline_keyboard=[[dict(text='How does it work', url='https://telegra.ph/Lists-of-Languages-available-in-the-bot-08-12')]])
        responce = bot.getChat(chat_id)
        first_name = responce['first_name']
        bot.sendChatAction(chat_id, 'typing')
        bot.sendMessage(chat_id, f'Hello <b>{first_name}</b> !', parse_mode='html',reply_markup=None)
        bot.sendChatAction(chat_id, 'typing')
        bot.sendMessage(chat_id, 'Welcome to <b>babylon</b> translator chat bot this bot will help you to translate different languges and helps you to explore more and to communicate better',parse_mode='html', reply_markup=markup)
        print(command)
    elif msg['text'] !='/start' and msg['text'].lower() != '/start':
        ...
        if not '|' in value:
            ...
            try:
                ...
                bot.sendMessage(chat_id, f'invalid destination! what does {user_dest} means see How does it works section!')


# get token from command-line
TOKEN = '1306385045:AAG1qheCr-0qpiu-mlox2TlEr4OcOcJBGIU'
