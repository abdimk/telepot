...
''''
This sample bot will show you image when you try to use inline mood
send image url it will download the image and send it back
'''
'''
# you don't need the server config if you are running the code in your pc👇 cut it out
'''
...
'''
# user the server confi if you are running this code on pythonanywhere.com 👆
'''
TOKEN = '1367069789:AAHEMbwm4S3V2oDn2KqPXzRUsCR8ildzRMs'


def fileShareFunction(msg):
    content_type, chat_type, chat_id = telepot.glance(msg)
    if content_type == 'text':
        # This simple for loop part will identify if your message is url or not
        message = msg['text']
        value = []
